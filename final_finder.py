...
if __name__ == '__main__':
    ...
    with open('tfidf_answers.npz', 'rb') as f:
        tfidf_answers = pickle.load(f)
    with open('tfidf_questions.npz', 'rb') as f:
    ...
    # Count Vectorizer
    print('loading Count...')
    with open('count_answers.npz', 'rb') as f:
        count_answers = pickle.load(f)
    with open('count_questions.npz', 'rb') as f:
